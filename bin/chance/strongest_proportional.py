...
from lib.matches.chance_based_matches.strongest_proportional_chance_match import StrongestProportionalChanceMatch
...
tl = BaseTieredLeague(pb, StrongestProportionalChanceMatch)
